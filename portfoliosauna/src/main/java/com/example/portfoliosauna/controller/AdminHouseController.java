...
import com.example.portfoliosauna.service.HouseService;
...
public class AdminHouseController {
    ...
    public String edit(@PathVariable(name = "id") Integer id, Model model) {
        ...
        HouseEditForm houseEditForm = new HouseEditForm(house.getId(), house.getName(), null,house.getAddress(), house.getAccess(), house.getPhoneNumber(), house.getHoliday(), house.getOpening_hours(), house.getPrice(), house.getDescription());
